...
IdMensaje int(15) auto_increment primary key, 
Mensaje varchar(140) not null, 
Emisor int(8) not null, 
Destinario int(8) not null, 
Fecha datetime not null, 
foreign key(Emisor) references personas(Cedula), 
foreign key(Destinario) references personas(Cedula)
);
