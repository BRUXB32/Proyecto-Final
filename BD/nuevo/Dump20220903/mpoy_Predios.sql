...
CREATE TABLE `Predios` (
  ...
  `CultivoAño` int DEFAULT NULL,
  `BajaLogica` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`IdPredio`),
  KEY `Cedula` (`Cedula`),
  CONSTRAINT `Predios_ibfk_1` FOREIGN KEY (`Cedula`) REFERENCES `Personas` (`Cedula`)
...
INSERT INTO `Predios` VALUES (1,10000008,1100,0),(2,12345678,1243,0),(3,NULL,0,0),(4,NULL,0,0),(5,NULL,0,0);
...
-- Dump completed on 2022-09-03 17:06:48
