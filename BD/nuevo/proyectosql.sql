...
Etapa enum('Recien Plantado','Z2.2','Z3.3','Reposo','Libre'),
CambioEstado date,
...
select Facturas.IdFactura,ProdEIns.Nombre,Facturas.Cantidad,Facturas.Fecha from Facturas,ProdEIns where Facturas.Cedula = 12345678 and Facturas.TipoT='C' and Facturas.IdPoI=ProdEIns.IdPoI;
select Facturas.IdFactura,ProdEIns.Nombre,Facturas.Cantidad,Facturas.Fecha from Facturas,ProdEIns where Facturas.Cedula = 12345678 and Facturas.TipoT='V' and Facturas.IdPoI=ProdEIns.IdPoI;
select Facturas.IdFactura,ProdEIns.Nombre,Facturas.Cantidad,Facturas.Fecha from Facturas,ProdEIns where Facturas.Cedula = 12345678 and Facturas.TipoT='C' and Facturas.Cantidad>2 and Facturas.IdPoI=ProdEIns.IdPoI;
select Facturas.IdFactura,ProdEIns.Nombre,Facturas.Cantidad,Facturas.Fecha from Facturas,ProdEIns where Facturas.Cedula = 12345678 and Facturas.TipoT='V' and Facturas.Cantidad<5 and Facturas.IdPoI=ProdEIns.IdPoI;
...
select count(*) from Facturas where Facturas.TipoT='C' and Facturas.Cedula = 12345678;
select count(*) from Facturas where Facturas.TipoT='V' and Facturas.Cedula = 12345678;
select count(*) from Facturas where Facturas.TipoT='C' and Facturas.Cedula = 12345678 and Facturas.Cantidad>2;
select count(*) from Facturas where Facturas.TipoT='V' and Facturas.Cedula = 12345678 and Facturas.Cantidad<5;
