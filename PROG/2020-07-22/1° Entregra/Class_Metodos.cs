...
namespace _1__Entregra
{
    internal class Class_Metodos
    {
        ...
        public static void AbrirFormulario<MiForm>(Panel pnl, bool cerrar, Label txt, string text) where MiForm : Form, new()
        {
        ...
        public static void DarValor(TextBox txt1, TextBox txt2, TextBox txt3, TextBox txt4, TextBox txt5, string text1, string text2, string text3, string text4, string text5)
        {
            txt1.Text = text1;
            txt2.Text = text2;
            txt3.Text = text3;
