    ...
    public partial class frm_Usuario : Form
    {
        ...
        private void txt_Borrar_Cedula_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Class_Metodos.Validacion_Cedula(txt_Borrar_Cedula.Text))
            {
                ...
                {
                    Class_Metodos.DarValor(txt_Borrar_Nombre, txt_Borrar_Contraseña, txt_Borrar_TipoUsuario, txt_Borrar_Correo, txt_Borrar_Telefono, "Administrativo", "1234A..", "Administrativo", "administrativo@gmail.com", "123456789");
                }
                else if (txt_Borrar_Cedula.Text.Equals("10000008"))
                {
                    Class_Metodos.DarValor(txt_Borrar_Nombre, txt_Borrar_Contraseña, txt_Borrar_TipoUsuario, txt_Borrar_Correo, txt_Borrar_Telefono, "Productor", "1234P..", "Productor", "productor@gmail.com", "123456782");
                }
                else
                {
                    Class_Metodos.DarValor(txt_Borrar_Nombre, txt_Borrar_Contraseña, txt_Borrar_TipoUsuario, txt_Borrar_Correo, txt_Borrar_Telefono, "", "", "", "", "");
                }
            }
            else
            {
        ...
        private void txt_Modificar_Cedula_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Class_Metodos.Validacion_Cedula(txt_Modificar_Cedula.Text))
            {
                ...
                {
                    Class_Metodos.DarValor(txt_Modificar_Nombre, txt_Modificar_NuevaCedula, txt_Modificar_Contraseña, txt_Modificar_Correo, txt_Modificar_Telefono, "Administrativo", "", "1234A..", "administrativo@gmail.com", "123456789");
                    cob_Modificar_TipoUsuario.SelectedIndex = 3;
                }
                else if (txt_Modificar_Cedula.Text.Equals("10000008"))
                {
                    Class_Metodos.DarValor(txt_Modificar_Nombre, txt_Modificar_NuevaCedula, txt_Modificar_Contraseña, txt_Modificar_Correo, txt_Modificar_Telefono, "Productor", "", "1234P..", "productor@gmail.com", "123456782");
                    cob_Modificar_TipoUsuario.SelectedIndex = 2;
                }
                else
                {
                    Class_Metodos.DarValor(txt_Modificar_Nombre, txt_Modificar_NuevaCedula, txt_Modificar_Contraseña, txt_Modificar_Correo, txt_Modificar_Telefono, "", "", "", "", "");
                    cob_Modificar_TipoUsuario.SelectedIndex = 0;
                }
            }
            else
        ...
        private void pic_ResetearContraseña_Click(object sender, EventArgs e)
        {
            if (Class_Metodos.Validacion_Cedula(txt_Modificar_Cedula.Text))
            {
                if (txt_Modificar_Cedula.Text.Equals("12345672"))
                {
                    txt_Modificar_Contraseña.Text = "1234A..";
                    err_Usuario.SetError(pic_Modificar_ContraseñaVisible, "");
                }
                else if (txt_Modificar_Cedula.Text.Equals("10000008"))
                {
                    txt_Modificar_Contraseña.Text = "1234P..";
                    err_Usuario.SetError(pic_Modificar_ContraseñaVisible, "");
                }
                else
                    Class_Metodos.PicBorrar(err_Usuario, pic_Modificar_ContraseñaVisible, txt_Modificar_Contraseña);
        ...
        private void btn_Modificar_Aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (correcto)
            {
                if (txt_Modificar_Cedula.Text.Equals("12345672") || txt_Modificar_Cedula.Text.Equals("10000008"))
                {
                    MessageBox.Show("Funciona");
                    Class_Metodos.PicBorrar(err_Usuario, pic_Modificar_BorrarCedula, txt_Modificar_Cedula);
                }
        ...
        private void txt_Listar_Cedula_TextChanged(object sender, EventArgs e)
        {
            ...
            if (listarPor == 0)
                if (Class_Metodos.Validacion_Cedula(txt_Listar_Cedula.Text))
                {
                    ...
                    {
                        Class_Metodos.DarValor(txt_Listar_Nombre, txt_Listar_Contraseña, txt_Listar_TipoUsuario, txt_Listar_Correo, txt_Listar_Telefono, "Administrativo", "1234A..", "Administrativo", "administrativo@gmail.com", "123456789");
                    }
                    else if (txt_Listar_Cedula.Text.Equals("10000008"))
                    {
                        Class_Metodos.DarValor(txt_Listar_Nombre, txt_Listar_Contraseña, txt_Listar_TipoUsuario, txt_Listar_Correo, txt_Listar_Telefono, "Productor", "1234P..", "Productor", "productor@gmail.com", "123456782");
                    }
                    else
                    {
                        Class_Metodos.DarValor(txt_Listar_Nombre, txt_Listar_Contraseña, txt_Listar_TipoUsuario, txt_Listar_Correo, txt_Listar_Telefono, "", "", "", "", "");
                    }
                }
                else
                {
